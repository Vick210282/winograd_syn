// WC_4_3.v generated by WCSyn.py
`timescale 1ns / 1ps
...
output reg [10*4-1:0] Z;
	...
	always@(posedge clk)begin
		...
		output_t[1] <=  0 + (MUL[1]) - (MUL[2]) + (MUL[3] <<< 1) - (MUL[4] <<< 1) + 0;
		output_t[2] <=  0 + (MUL[1]) + (MUL[2]) + (MUL[3] <<< 2) + (MUL[4] <<< 2) + 0;
		output_t[3] <=  0 + (MUL[1]) - (MUL[2]) + (MUL[3] <<< 3) - (MUL[4] <<< 3) +  (MUL[5]);
